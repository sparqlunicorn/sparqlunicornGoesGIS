...
class OntDocDialog(QtWidgets.QDialog, FORM_CLASS):
    ...
    def createDocumentation(self):
        ...
        self.qtask = OntDocTask("Creating ontology documentation... ",
                                        ...
                                        self.outFolderWidget.filePath(),self.additionalCollections.checkState(),baselayerss,tobeaddedperInd, maincolor, titlecolor,progress,self.createIndexPages.checkState(),self.nonNSPagesCBox.checkState(),self.createMetadataTableCBox.checkState(),logoname)
