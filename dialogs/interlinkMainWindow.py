...
class InterlinkMainWindow(QtWidgets.QMainWindow, FORM_CLASS):
    ...
    def __init__(self, maindlg=None,  parent=None):
        """Constructor."""
        super(InterlinkMainWindow, self).__init__(parent)
        sparqlunicorndlg = maindlg
        self.setupUi(self)
        ...
        self.refreshLayersInterlink.clicked.connect(sparqlunicorndlg.loadUnicornLayers)
    ...
    #         sparqlunicorndlg.buildSearchDialog(row, column, True, self.interlinkTable, True, False, None, self.addVocabConf)
    #     elif column >= 7:
    ...
    #     elif column == -1:
    #         sparqlunicorndlg.buildSearchDialog(row, column, -1, self.interlinkOwlClassInput, False, False, None, self.addVocabConf)
    ...
    #     sparqlunicorndlg.searchTripleStoreDialog.check_state(self.interlinkNameSpace)
